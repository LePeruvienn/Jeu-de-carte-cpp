...
int main() {
  ...
  vector<string> nomR = {"Robot 1","Playboy Carti","Maxence","NOS","Ademo","YassEncore","Maxime Biaggi","Emmanuel Macron","BOT Mallory","GrimKujow","DylanKujo2","BOT Olivier","BOT Maxence","BOT Melanchon","BOT Olivier","Roi Doryan","Roi Arthur","BOT RYAN"};
  ...
  /// Teste classe : carte
  cout << "///////////////// carte /////////////////" << endl << endl;
  // initialisation
  carte c;
  carte c1("Objet 0", 5, 3, 2);
  carte c2("Objet 1", 6, 1, 3);
  carte c3("Objet 2", 3, 3, 1);
  carte c4("Objet 3", 1, 4, 5);
  carte c5("Objet 4", 2, 6, 4);
  carte c6("Objet 5", 4, 2, 2);
  /// teste affichage
  ...
  /// teste get
  cout << "--------------- get ---------------" << endl << endl;
  cout << "attaque :" << c.getAttaque() << endl;
  cout << "magie :" << c.getMagie() << endl;
  cout << "defense :" << c.getDefense() << endl;
  ...
  cout << "Degats physique Epee de fou -> Epee nul : " << c1.degatPhysique(c2)
       << endl;
  cout << "Degats magique Epee de fou -> Epee nul : " << c1.degatMagique(c2)
       << endl;

  sautLigne(5);

  joueur j1("Arthur", 25, {c1, c2, c3, c4, c5, c6});
  joueur j2("Théo", 25, {c});
